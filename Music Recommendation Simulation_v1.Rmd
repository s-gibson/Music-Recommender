...
```{r}
N_recs <- 20
recommended.items <- predict(Rec.model_bin, Test.Affinity, n = N_recs)
User.plays <- Lastfm[which(Lastfm$usersha1 == rownames(Test.Utility)),][,c(3:4)] #[which(Lastfm$usersha1 == rownames(samp.Utility[N_samp]))]
